...
class Ui_vtn_principal(object):
    def setupUi(self, vtn_principal):
        ...
        self.btn_grabar.setGeometry(QRect(200, 270, 93, 28))
        ...
        self.lbl_tipo_persona.setGeometry(QRect(40, 20, 91, 16))
        ...
        self.mnb_menu_principal.setGeometry(QRect(0, 0, 529, 26))
    ...
    def retranslateUi(self, vtn_principal):
        ...
        self.lbl_tipo_persona.setText(QCoreApplication.translate("vtn_principal", u"Tipo Persona:", None))
